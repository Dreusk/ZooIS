...
namespace ZooIS.Data.Migrations
{
    ...
    [Migration("20221029091857_Update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZooIS.Models.Name", b =>
                {
            ...
            modelBuilder.Entity("ZooIS.Models.Status", b =>
                {
                    b.Property<Guid>("AnimalGuid")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZooIS.Models.Name", b =>
                {
                    b.HasOne("ZooIS.Models.Employee", "Employee")
                        .WithOne("Name")
                        .HasForeignKey("ZooIS.Models.Name", "EmployeeGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ZooIS.Models.Status", b =>
                {
                    b.HasOne("ZooIS.Models.Animal", "Animal")
                        .WithOne("Status")
                        .HasForeignKey("ZooIS.Models.Status", "AnimalGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
